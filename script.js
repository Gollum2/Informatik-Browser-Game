...
window.addEventListener('resize', function (event) {
    ...
    heightmargin = newHeight - fieldcoutheight * fieldsize;
    widthmargin = newWidth - fieldcoutwidth * fieldsize;
...
function gameloop() {
    ...
    let left = $("#maindiv").css("left");
    let top = $("#maindiv").css("top");
    console.log(coordsx);
    console.log(coordsy);
